...
* [Interpreting results](#interpretion)
  * [Plots description](#plots)
  * [Type of mutations](#Types)
  * [Search for a fragment of genome including around location of the mutations](#blast)
  * [Number of important variants (mutations) in various genomic regions (e.g. genes)](#freq)
* [Support](#support)
------------------------------------------------------------------------------------------------------------------------------
# Features #
...
<h2 id="blast">
Search for a fragment of genome including around location of the mutations</h2>


<h2 id="freq">
Number of important variants (mutations) in various genomic regions (e.g. genes)
</h2>
